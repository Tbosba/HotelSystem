...
namespace HotelSystem.Models
{
    public class EmailService
    {
        ...
        private const string Host = "Host", Port = "Port", MailFrom = "MailFrom", Password = "Password";
        ...
        public EmailService()
        {
            ...
            smtpClient.Credentials = new System.Net.NetworkCredential(ConfigurationManager.AppSettings[MailFrom], ConfigurationManager.AppSettings[Password]);
            mailFrom = new MailAddress(ConfigurationManager.AppSettings[MailFrom], "Kapenta Bay Hotel");
        }
